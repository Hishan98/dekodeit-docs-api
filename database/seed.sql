...
-- -----------------------------------------------------------------------------
-- Users  (password for both accounts: admin123)
...
INSERT INTO projects
    (id, name, description, client_id, service_id, phase, total_amount, status,
...
(
    ...
    3, 3, 'completed', 150000.00, 'completed',
...
(
    ...
    6, 1, 'submitted', 400000.00, 'active',
    NULL, NULL,
...
(
    ...
    2, 6, 'completed', 45000.00, 'completed',
...
(7, 'P260107', 2, 6, 1, 'Q1 2025 Support Agreement — 3 Months',
  45000.00, 'LKR', DATE_SUB(CURDATE(), INTERVAL 3 MONTH), 'accepted',
...
(8, 'P260108', 2, 7, 1, 'Annual Support Agreement 2025 — 12 Months',
  180000.00, 'LKR', DATE_ADD(CURDATE(), INTERVAL 7 DAY), 'accepted',
...
(9, 'P260109', 1, 8, 1, 'Dark Mode & Accessibility Upgrade — Professional Services',
  95000.00, 'LKR', DATE_ADD(CURDATE(), INTERVAL 14 DAY), 'sent',
...
INSERT INTO service_agreements
    (agreement_number, project_id, template_id, subject, status, notes, created_by)
VALUES
('S260101', 1, 1, 'E-Commerce Website Development Agreement',
 'signed', 'Signed and executed, project kicked off', 1),

('S260102', 2, 1, 'Mobile Banking App Development Agreement',
 'signed', 'Signed, awaiting Purchase Order from client', 1),

('S260103', 3, 1, 'Brand Identity Design Agreement',
 'signed', 'Signed, project completed', 1),

('S260104', 4, 1, 'Retail Management System Development Agreement',
 'sent', 'Sent alongside proposal, awaiting client acceptance', 1);

-- -----------------------------------------------------------------------------
-- Invoices  (only for projects with PO — Projects 1 and 3)
-- -----------------------------------------------------------------------------
INSERT INTO invoices
    (id, invoice_number, client_id, project_id, proposal_id, template_id,
...
INSERT INTO payments
    (invoice_id, proposal_id, project_id, payment_type, amount, payment_date,
     payment_method, reference_number, description, recipient_name, recipient_type, created_by)
VALUES
-- Project 1 (E-Commerce)
(1, 1, 1, 'advance',           250000.00, DATE_SUB(CURDATE(), INTERVAL  5 DAY),
 'Bank Transfer', 'TXN2601001', 'E-commerce advance payment (50%)',   NULL,            'company',   1),
(1, 1, 1, 'broker_commission',  25000.00, DATE_SUB(CURDATE(), INTERVAL  4 DAY),
 'Bank Transfer', 'TXN2601002', 'Broker commission, referral fee',    'John Broker',   'broker',    1),
(1, 1, 1, 'developer_payment', 150000.00, DATE_SUB(CURDATE(), INTERVAL  3 DAY),
 'Bank Transfer', 'TXN2601003', 'Developer payment, frontend team',   'Dev Team Alpha','developer', 1),
-- Project 3 (Brand Identity)
(2, 3, 3, 'advance',            75000.00, DATE_SUB(CURDATE(), INTERVAL 50 DAY),
 'Bank Transfer', 'TXN2603001', 'Branding advance payment (50%)',     NULL,            'company',   1),
(2, 3, 3, 'final',              75000.00, DATE_SUB(CURDATE(), INTERVAL 15 DAY),
 'Bank Transfer', 'TXN2603002', 'Branding final payment (50%)',       NULL,            'company',   1);
